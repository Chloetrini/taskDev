      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-10 my-10 md:my-13 mx-auto container max-w-[1200px] px-4">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-[#737171] text-[16px] sm:text-[20px] md:text-[24px] font-[400] max-w-full md:max-w-[535px] py-5 leading-relaxed">
            Task management built for how developers actually work.
            track progress across your entire stack without switching tools or losing context.
          </p>
          <button
            onClick={() => navigate("/tasks")} className="py-[10px] px-[25px] text-[18px] sm:text-[22px] md:text-[24px] font-[500] bg-[#974FD0] text-white rounded-[8px] hover:bg-[#7d3db0] transition-colors w-full sm:w-auto" >
            Go to My Tasks
          </button>
        </div>
        <img
          src={hero}alt="hero"className="w-full max-w-[300px] sm:max-w-[380px] md:max-w-[480px] mx-auto md:mx-0"/>
      </div>
    </div>
  )
}
